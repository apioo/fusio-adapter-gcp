...
use Fusio\Adapter\Google\Connection\BigQuery;
...
class BigQueryTest extends TestCase
{
    ...
    {
        /** @var BigQuery $connectionFactory */
        $connectionFactory = $this->getConnectionFactory()->factory(BigQuery::class);
        ...
        $this->assertInstanceOf(BigQueryClient::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(BigQuery::class);
        $builder    = new Builder();
