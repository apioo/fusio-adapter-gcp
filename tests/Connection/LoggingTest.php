...
class LoggingTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetConnection()
    {
        ...
        $connectionFactory = $this->getConnectionFactory()->factory(Logging::class);
        ...
        $this->assertInstanceOf(LoggingClient::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(Logging::class);
        $builder    = new Builder();
