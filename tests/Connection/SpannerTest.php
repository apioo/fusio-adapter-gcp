...
use Fusio\Adapter\Google\Connection\Spanner;
...
class SpannerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        if (!extension_loaded('grpc')) {
            $this->markTestSkipped('grpc extension not installed');
        }
    }

    public function testGetConnection()
    {
        /** @var Spanner $connectionFactory */
        $connectionFactory = $this->getConnectionFactory()->factory(Spanner::class);
        ...
        $this->assertInstanceOf(SpannerClient::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(Spanner::class);
        $builder    = new Builder();
