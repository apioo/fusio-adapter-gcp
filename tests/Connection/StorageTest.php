...
use Fusio\Adapter\Google\Connection\Storage;
...
class StorageTest extends TestCase
{
    ...
    {
        /** @var Storage $connectionFactory */
        $connectionFactory = $this->getConnectionFactory()->factory(Storage::class);
        ...
        $this->assertInstanceOf(StorageClient::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(Storage::class);
        $builder    = new Builder();
